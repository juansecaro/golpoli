class AdvertisersController < ApplicationController
  ...
  private
    ...
    def advertiser_params
      params.require(:advertiser).permit(:name, :address, :cif, :city, :postal_code, :bank, :paypal, :other, :price, :start_date, :duration, :url1, :url2, :url3, :active_url, :active, :entity_id)
    end
end
